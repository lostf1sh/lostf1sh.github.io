...
<template>
    <nav aria-label="Primary navigation" class="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs mb-10 pb-3 border-b border-ink-surface/40">
        <router-link
        ...
        <span class="text-ink-surface/50">│</span>
        <a
