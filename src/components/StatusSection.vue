    ...
    <div class="tui-panel">
        ...
        <div class="space-y-1.5 text-xs pt-1">
            <div
                ...
                class="space-y-1.5"
            >
                <div class="skeleton-pulse h-3 w-48 bg-ink-surface/40"></div>
                <div class="skeleton-pulse h-3 w-40 bg-ink-surface/30"></div>
            </div>
            ...
            <div class="flex items-baseline gap-2 min-w-0">
                <span class="text-ink-subtle flex-shrink-0">music</span>
                <span
                    v-if="!showPresenceSkeleton && spotify"
                    class="text-ink-text min-w-0 block truncate"
